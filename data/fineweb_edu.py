"""
FineWeb-Edu 100B dataset preprocessing.
https://huggingface.co/datasets/HuggingFaceFW/fineweb-edu

example doc to highlight the structure of the dataset:
{
  "text": "Wars have given us the Jeep, the computer and even the microwave...",
  "id": "<urn:uuid:749f4f2e-01bf-42ab-ac03-1dfa84af34dc>",
  "dump": "CC-MAIN-2013-20",
  "url": "http://articles.baltimoresun.com/...",
  "date": null,
  "file_path": "s3://commoncrawl/crawl-data/...",
  "language": "en",
  "language_score": 0.959887,
  "token_count": 1205,
  "score": 2.828125,
  "int_score": 3
}
...
parser = argparse.ArgumentParser(description="FineWeb-Edu 100B dataset preprocessing")
parser.add_argument("-s", "--shard_size", type=int, default=10**8, help="Size of each shard in tokens")
args = parser.parse_args()

local_dir = "fineweb_edu100B"
