...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None, loss_chunk_size = 4096):
...
class DistributedDataLoader:
    ...
    def reset(self):
        ...
        arr = _load_data_shard(self.files[self.current_shard]).astype(np.int64)
        self.tokens = torch.from_numpy(arr).pin_memory()
